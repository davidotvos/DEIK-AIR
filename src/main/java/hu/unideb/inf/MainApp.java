...
//        }
    ...
    public static void startDB() throws SQLException{
        ...
        try (FlightsDAO fDao = new JpaFlightsDAO()) {
            ...
            Flights deb_ber1 = new Flights("deb_ber1", "Debrecen", "Berlin", "Boeing 747-400", "2022.05.20 12:00");
            deb.addFlightToList(deb_ber1);
            fDao.saveFlight(deb_ber1);
            Flights deb_rom1 = new Flights("deb_rom1", "Debrecen", "Roma", "Boeing 747-400", "2022.05.20 14:00");
            deb.addFlightToList(deb_rom1);
            fDao.saveFlight(deb_rom1);
            Flights deb_lon1 = new Flights("deb_lon1", "Debrecen", "London", "Hawker Hurricane", "2022.05.20 10:00");
            deb.addFlightToList(deb_lon1);
            fDao.saveFlight(deb_lon1);
            Flights deb_bar1 = new Flights("deb_bar1", "Debrecen", "Barcelona", "Hawker Hurricane", "2022.05.20 11:00");
            deb.addFlightToList(deb_bar1);
            fDao.saveFlight(deb_bar1);
            Flights deb_par1 = new Flights("deb_par1", "Debrecen", "Paris", "Hawker Hurricane", "2022.05.20 14:00");
            deb.addFlightToList(deb_par1);
            fDao.saveFlight(deb_par1);
            Flights deb_vie1 = new Flights("deb_vie1", "Debrecen", "Vienna", "Airbus A330-300", "2022.05.20 16:00");
            deb.addFlightToList(deb_vie1);
            fDao.saveFlight(deb_vie1);
            Flights deb_ams1 = new Flights("deb_ams1", "Debrecen", "Amstedam", "Boeing 747-400", "2022.05.20 14:30");
            deb.addFlightToList(deb_ams1);
            fDao.saveFlight(deb_ams1);
            Flights deb_pra1 = new Flights("deb_pra1", "Debrecen", "Prague" , "Fairchild-Dornier 328JET", "2022.05.20 14:30");
            deb.addFlightToList(deb_pra1);
            fDao.saveFlight(deb_pra1);
            Flights deb_bern1 = new Flights("deb_bern1", "Debrecen", "Bern" , "Antonov An-12", "2022.05.20 16:00");
            deb.addFlightToList(deb_bern1);
            fDao.saveFlight(deb_bern1);
            Flights deb_ber2 = new Flights("deb_ber2", "Debrecen", "Berlin", "Boeing 747-400", "2022.05.23 12:00");
            deb.addFlightToList(deb_ber2);
            fDao.saveFlight(deb_ber2);
            Flights deb_rom2 = new Flights("deb_rom2", "Debrecen", "Roma", "Boeing 747-400", "2022.05.22 15:00");
            deb.addFlightToList(deb_rom2);
            fDao.saveFlight(deb_rom2);
            Flights deb_lon2 = new Flights("deb_lon2", "Debrecen", "London", "Hawker Hurricane", "2022.05.22 12:00");
            deb.addFlightToList(deb_lon2);
            fDao.saveFlight(deb_lon2);
            Flights deb_bar2 = new Flights("deb_bar2", "Debrecen", "Barcelona", "Hawker Hurricane", "2022.05.24 16:00");
            deb.addFlightToList(deb_bar2);
            fDao.saveFlight(deb_bar2);
            Flights deb_par2 = new Flights("deb_par2", "Debrecen", "Paris", "Hawker Hurricane", "2022.05.23 18:00");
            deb.addFlightToList(deb_par2);
            fDao.saveFlight(deb_par2);
            Flights deb_vie2 = new Flights("deb_vie2", "Debrecen", "Vienna", "Airbus A330-300", "2022.05.25 16:00");
            deb.addFlightToList(deb_vie2);
            fDao.saveFlight(deb_vie2);
            Flights deb_ams2 = new Flights("deb_ams2", "Debrecen", "Amstedam", "Boeing 747-400", "2022.05.24 15:30");
            deb.addFlightToList(deb_ams2);
            fDao.saveFlight(deb_ams2);
            Flights deb_pra2 = new Flights("deb_pra2", "Debrecen", "Prague" , "Fairchild-Dornier 328JET", "2022.05.23 10:00");
            deb.addFlightToList(deb_pra2);
            fDao.saveFlight(deb_pra2);
            Flights deb_bern2 = new Flights("deb_bern2", "Debrecen", "Bern" , "Antonov An-12", "2022.05.23 8:00");
